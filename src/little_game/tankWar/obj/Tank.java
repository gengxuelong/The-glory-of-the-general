...
public abstract class Tank extends GameObject {
    ...
    public Tank(String image, int x, int y, AbstractFrame gameFrame,
        ...
        this.right_I = Toolkit.getDefaultToolkit().createImage(right);
        this.left_I = Toolkit.getDefaultToolkit().createImage(left);
        this.up_I = Toolkit.getDefaultToolkit().createImage(up);
        this.down_I = Toolkit.getDefaultToolkit().createImage(down);
    }
