 ...
 * @author lijie
 */
public class GameFrame3 extends AbstractFrame {
    ...
    public void loadingWall() {
        for (int i = 0 ;i<15;i++){
            HardWall h = new HardWall("./resource/imageForTank/54.jpg",25*(3*i+3),25*3,this);
            wallList.add(h);
        }

        for (int i = 0 ;i<15;i++){
            HardWall h = new HardWall("./resource/imageForTank/54.jpg",25*(3*i+3),25*9,this);
            wallList.add(h);
        }

        for (int i = 0 ;i<15;i++){
            HardWall h = new HardWall("./resource/imageForTank/54.jpg",25*(3*i+3),25*15,this);
            wallList.add(h);
        }

        for (int i = 0 ;i<16;i++){
            HardWall h = new HardWall("./resource/imageForTank/54.jpg",25*(3*i+1),25*6,this);
            wallList.add(h);
        }
        for (int i = 0 ;i<16;i++){
            HardWall h = new HardWall("./resource/imageForTank/54.jpg",25*(3*i+1),25*12,this);
            wallList.add(h);
        }
        for (int i = 0 ;i<16;i++){
            HardWall h = new HardWall("./resource/imageForTank/54.jpg",25*(3*i+1),25*18,this);
            wallList.add(h);
        }
        for (int i = 0 ;i<10;i++){
            HardWall h = new HardWall("./resource/imageForTank/54.jpg",25*(3*i+10),25*21,this);
            wallList.add(h);
        }

        for (int i = 0 ;i<14;i++){
            HardWall h = new HardWall("./resource/imageForTank/54.jpg",25*(3*i+3),25*23,this);
            wallList.add(h);
        }
        for (int i = 0 ;i<14;i++){
            HardWall h = new HardWall("./resource/imageForTank/54.jpg",25*(3*i+3),25*13,this);
            wallList.add(h);
        }
