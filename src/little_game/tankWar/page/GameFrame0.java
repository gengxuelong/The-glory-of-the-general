...
public class GameFrame0 extends AbstractFrame {
    ...
    public void loadingWall() {
        for (int i = 0; i < 48; i++) {
            Wall w = new Wall("./resource/imageForTank/wall.jpg", 25 * i, 400, this);
            wallList.add(w);
        }

        for (int i = 0; i < 48; i++) {
            Wall w = new Wall("./resource/imageForTank/wall.jpg", 25 * i, 200, this);
            wallList.add(w);
        }
        for (int i = 0; i < 48; i++) {
        ...
        Wall w4 = new Wall("./resource/imageForTank/wall.jpg", 575, 550, this);
        ...
        Wall w8 = new Wall("./resource/imageForTank/wall.jpg", 575, 575, this);
        Wall w9 = new Wall("./resource/imageForTank/wall.jpg", 575, 600, this);
        Wall w10 = new Wall("./resource/imageForTank/wall.jpg", 575, 625, this);
        wallList.add(w1);
        wallList.add(w2);
        wallList.add(w3);
        wallList.add(w4);
