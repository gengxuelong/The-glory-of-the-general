package little_game.planeWar.planeWar_5_6.page;

import little_game.planeWar.planeWar_5_6.obj.*;
...
public class Frame2 extends AbstractFrame {
	...
	private final Frame2 frame = this;
	public void launch() {
	...
	public void paint(Graphics g) {
		...
		if (state == 1) {
			...
			gImage.drawRect(20, 50, 300, 20);
			gImage.setColor(Color.red);
			gImage.fillRect(20, 51, (boss_3.live + boss_2.live + boss_3.live) / 50, 19);
		...
		if (state == 4) {
			...
			gImage.setColor(Color.red);
			gImage.fillRect(20, 51, boss_3.live / 50, 19);
			for (Stone s : stoneList) {
				s.paintSelf(gImage);
			}
			for (gameObject obj : objList) {
