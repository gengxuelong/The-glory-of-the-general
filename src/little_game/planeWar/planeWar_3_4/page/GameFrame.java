...
public class GameFrame extends AbstractFrame {
    ...
    public void createObj2(){
        ...
        a = r.nextInt(1200);
        if (count % 100 == 1) {//创造敌机
            EnemyPlane1 enemyPlane = new EnemyPlane1(value.enemy1, a, 100, 20, 20, this);
        ...
        if (count % 100 == 11) {//创造敌机
            EnemyPlane1 enemyPlane = new EnemyPlane1(value.enemy1, a, 100, 20, 20, this);
            enemyList.add(enemyPlane);
            objList.add(enemyPlane);
        }
        if (count % 100 == 16) {//创造敌机
            EnemyPlane1 enemyPlane = new EnemyPlane1(value.enemy1, a, 100, 20, 20, this);
            enemyList.add(enemyPlane);
            objList.add(enemyPlane);
        }
        if (count % 100 == 21) {//创造敌机
            EnemyPlane1 enemyPlane = new EnemyPlane1(value.enemy1, a, 100, 20, 20, this);
            enemyList.add(enemyPlane);
            objList.add(enemyPlane);
        }
        if (count % 100 == 26) {//创造敌机
            EnemyPlane1 enemyPlane = new EnemyPlane1(value.enemy1,a, 100, 20,20, this);
            enemyList.add(enemyPlane);
            objList.add(enemyPlane);
        }
        if (count % 100 == 31) {//创造敌机
            EnemyPlane1 enemyPlane = new EnemyPlane1(value.enemy1, a, 100, 20, 20, this);
            enemyList.add(enemyPlane);
            objList.add(enemyPlane);
        }
        if (count % 100 == 36) {//创造敌机
            EnemyPlane1 enemyPlane = new EnemyPlane1(value.enemy1, a, 100, 20, 20, this);
            enemyList.add(enemyPlane);
            objList.add(enemyPlane);
        }
        ...
        if (count % 100 == 72) {//创造敌机
            EnemyPlane2 enemyPlane = new EnemyPlane2(value.enemy2, b, 200, 20, 20, this);
            enemyList.add(enemyPlane);
            objList.add(enemyPlane);
        }
        if (count % 100 == 77) {//创造敌机
            EnemyPlane2 enemyPlane = new EnemyPlane2(value.enemy2, b, 200, 20, 20, this);
            enemyList.add(enemyPlane);
            objList.add(enemyPlane);
        }
        if (count % 100 == 82) {//创造敌机
            EnemyPlane2 enemyPlane = new EnemyPlane2(value.enemy2, b, 200, 20, 20, this);
            enemyList.add(enemyPlane);
            objList.add(enemyPlane);
        }
        if (count % 100 == 87) {//创造敌机
            EnemyPlane2 enemyPlane = new EnemyPlane2(value.enemy2, b, 200, 20, 20, this);
            enemyList.add(enemyPlane);
            objList.add(enemyPlane);
        }
        if (count % 100 == 92) {//创造敌机
            EnemyPlane2 enemyPlane = new EnemyPlane2(value.enemy2, b, 200, 20, 20, this);
            enemyList.add(enemyPlane);
            objList.add(enemyPlane);
        }
        if (count % 100 == 97) {//创造敌机
            EnemyPlane2 enemyPlane = new EnemyPlane2(value.enemy2, b, 200, 20, 20, this);
            enemyList.add(enemyPlane);
            objList.add(enemyPlane);
        }
