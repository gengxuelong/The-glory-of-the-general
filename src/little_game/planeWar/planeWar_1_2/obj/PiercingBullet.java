 ...
 * 我方子弹类
 */
public class PiercingBullet extends gameObject{
	
	int spX;
	int spY;
	boolean bossAttack = false;
	
    public PiercingBullet(Image image, int x, int y, int width, int height, AbstractFrame gameFrame,int spX,int spY) {
