...
/**
 * 高压模式，boss两倍血量，四倍敌机，但是可以自由切换弹种
 * @author PYE
 *
 */
public class PYFrameONE extends AbstractFrame {
    private final PYFrameONE frameOne = this;

    public void launch(){
    	this.getBoss_1().setBossHP(1000);
    ...
    public void paint(Graphics g){
        ...
        if(state == 1){
            ...
            gImage.fillRect(20,51,boss_1.live/10,19);
        ...
        if(state == 4){
            ...
            gImage.drawRect(20,50,100,20);
            gImage.setColor(Color.red);
            gImage.fillRect(20,51,boss_1.live/15,19);
            for(Stone s : stoneList){
                s.paintSelf(gImage);
            }
            for(gameObject obj : objList){
