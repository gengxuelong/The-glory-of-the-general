...
/**
 * @author wen rui
 * @Date 2021/12/23 21:44
 */
public class Atlas_A_YuXiangGuiHuiZhan extends Atlas {
    private Atlas_A_YuXiangGuiHuiZhan(Image image, int xForBg, int yForBg, int width, int height) {
        this.image = image;
        this.xForBg = xForBg;
        this.yForBg = yForBg;
        this.width = width;
    ...
    public static Atlas_A_YuXiangGuiHuiZhan instance () {
        return new Atlas_A_YuXiangGuiHuiZhan(values.atlas_QiQiShiBian, -150, -1590, 3000, 3000);
    }
    @Override
