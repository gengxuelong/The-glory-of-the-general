 ...
 * @author  wangxiaoyang
 */
public class MiddleArmsFactory extends ArmsFactory{



    {this.iron=32;}//工业值生产效率

    public MiddleArmsFactory(MyPoint point, int temp) {
        super(point, temp);

        this.image= values.MiddleArmsFactory;
    ...
    public void keyPressed(KeyEvent e) {
       ...
       if(frame.getNowCamp()==camp){
        ...
        if(key == KeyEvent.VK_Q){
            JOptionPane.showMessageDialog(frame,"中型兵工厂，，可以生产装甲车，轻坦克，中型坦克，轻火炮，重火炮\n按1生产装甲车，按2生产轻坦克，生产中型坦克，按4生产轻火炮，按5生产重火炮\n装甲车花费：130金币，60工业值；轻坦克花费：180金币，90工业值，轻火炮花费：160金币，50工业值\n中型坦克花费：220金币，110工业值；中型火炮花费：170金币，80工业值\n每回合产值：32工业值",null,1,new ImageIcon(image));
        }
    }
