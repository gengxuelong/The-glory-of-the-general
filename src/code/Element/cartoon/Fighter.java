...
public class Fighter extends TroopObject {

    {
        price = new MyPoint(220,50);
    }
    ...
    public Fighter(){};
    public Fighter(Frame frame, MyPoint point, int temp){
        this.myPoint = point;
        loadPoint();
        this.frame = frame;
        this.setCamp(temp);
    ...
    private void setImage(int temp){
        switch (temp){
            case GameObject.KMT:
            case GameObject.US:image = values.fighter_General;break;
            case GameObject.JAPAN:image = values.fighter_Japan;break;
            case GameObject.CPC:image = values.fighter_China;break;
